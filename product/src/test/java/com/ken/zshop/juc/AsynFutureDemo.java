...
public class AsynFutureDemo {
    public static void runAsync(String[] args) throws ExecutionException, InterruptedException {
        ...
        CompletableFuture<Void> future = CompletableFuture.runAsync(() -> {
            ...
            int i = 10 / 2;
            log.info("线程名称：{},线程执行结果：{}", Thread.currentThread().getName(),i);  // ForkJoinPool.commonPool-worker-1
    ...
    public static void runAsync2(String[] args) throws ExecutionException, InterruptedException {
        log.info("主线程start............");
        CompletableFuture<Void> future = CompletableFuture.runAsync(() -> {
            log.info("子线程future线程start............");
            int i = 10 / 2;
            log.info("线程名称：{},线程执行结果：{}", Thread.currentThread().getName(),i);  //  pool-1-thread-1
            log.info("子线程future线程end............");
        }, threadPool);
        future.get();
        log.info("主线程end............");
    ...
    public static void thenRun(String[] args) throws ExecutionException, InterruptedException {
    ...
    public static void handle(String[] args) throws ExecutionException, InterruptedException {
